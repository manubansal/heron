...
public class HomogeneousPackingTest {
  ...
  private PackingPlan getHomogeneousPackingPlan(TopologyAPI.Topology topology) {
    ...
    HomogeneousPacking packing = new HomogeneousPacking();
  ...
  public void testEvenPacking() throws Exception {
    ...
    PackingPlan output = getHomogeneousPackingPlan(topology);
